        ...
        <div className="container flex h-14 items-center">
          <div className="mr-4 flex">
            <Link to="/" className="mr-6 flex items-center space-x-2">
              <span className="font-bold">hash8/ui</span>
            </Link>
        ...
        <section className="container py-8 md:py-12 lg:py-24">
          <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
            <div className="relative overflow-hidden rounded-lg border bg-background p-6">
              ...
              <div className="space-y-2 pt-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Components built with Radix UI primitives. Keyboard navigation
            ...
            <div className="relative overflow-hidden rounded-lg border bg-background p-6">
              ...
              <div className="space-y-2 pt-4">
                <h3 className="font-bold">Themeable</h3>
                <p className="text-sm text-muted-foreground">
                  Styled using CSS variables and Tailwind. Customize colors,
                  spacing, and more.
                </p>
              </div>
            </div>
            <div className="relative overflow-hidden rounded-lg border bg-background p-6">
              ...
              <div className="space-y-2 pt-4">
                ...
                <p className="text-sm text-muted-foreground">
                  No package installation required. Just copy the code and adapt
                  it to your needs.
                </p>
              </div>
            </div>
        ...
        <section className="container py-8 md:py-12 lg:py-24">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
            ...
            <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              A collection of essential UI components built with Radix and styled
              with Tailwind CSS.
            </p>
          </div>
          <div className="mx-auto mt-8 grid max-w-[64rem] gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <Link
                key={component.name}
                to={component.href}
                className="group relative overflow-hidden rounded-lg border bg-background p-4 hover:border-foreground/50"
              >
