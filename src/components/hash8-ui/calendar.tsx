...
import { buttonVariants } from "@/components/hash8-ui/button";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium flex items-center justify-center",
      ...
      components={{
        ...
        IconDropdown: ({ ..._props }) => <ChevronDownIcon className="h-4 w-4" />,
      }}
      formatters={{
        formatMonthCaption: (date) => format(date, "MMM"),
      }}
      {...props}
    />
  );
